...
export function AppSidebar() {
  ...
  return (
    <motion.aside
      ...
      className="h-screen glass-dark flex flex-col border-r border-border/50 shrink-0"
    >
      {/* Header */}
          ...
          <div className="flex items-center gap-2">
            ...
            <AnimatePresence>
              {!collapsed && (
                ...
                >
                  <h1 className="font-display text-lg font-bold gradient-text whitespace-nowrap">
                    AutoParts AZ
                  </h1>
                </motion.div>
              )}
